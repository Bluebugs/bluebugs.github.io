...
This draws from Miguel Young de la Sota's ["Designing a SIMD Algorithm from Scratch"](https://mcyoung.xyz/2023/11/27/simd-base64/). Go read his article for the deep dive -- this one focuses on how the same algorithm could look in Go with an SPMD extension.
